...
public class MetricUpdate {
    ...
    */
    ...
    int getId(String s){
        if(mp.containsKey(s)){
            ...
            try{
                File dir;
                dir = new File("/home/manoj/sdn/onos-apps/gru-app/meta.txt");
    ...
    */
    ...
    void predValues(){
        ...
        printMetrics(norm_metrics , "/home/manoj/sdn/onos-apps/gru-app/norm_data.csv");

        log.info("Metrics Printed");
        printMetrics(metrics , "/home/manoj/sdn/onos-apps/gru-app/metric_data.csv");
        ...
        printMetrics(pred_vals, "/home/manoj/sdn/onos-apps/gru-app/pred_data.csv");
